...
Issue forms live in `.github/ISSUE_TEMPLATE/`; the PR body template is `.github/PULL_REQUEST_TEMPLATE.md`. Optional Copilot code review is a repo setting, not a workflow.
